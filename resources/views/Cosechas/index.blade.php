                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <h3 class="display-5 fw-bolder mb-0">${{ number_format($totalIngresos, 0, ',', '.') }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <h3 class="display-5 fw-bolder mb-0">${{ number_format($totalGastos, 0, ',', '.') }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <h3 class="display-5 fw-bolder mb-0">${{ number_format($utilidadTotal, 0, ',', '.') }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <h3 class="display-5 fw-bolder mb-0">{{ $rentabilidad }}%</h3>
                        </div>
                    </div>
                </div>
            </div>
