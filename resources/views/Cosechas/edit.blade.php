                    ...
                    <form action="{{ route('Cosechas.update',$cosecha->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" id="fechaCreacion" name="fechaCreacion"
                                class="form-control @error('fechaCreacion') is-invalid @enderror" value="{{$cosecha->fechaCreacion}}">
                            @error('fechaCreacion')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" id="fechaSiembra" name="fechaSiembra"
                                class="form-control @error('fechaSiembra') is-invalid @enderror" value="{{$cosecha->fechaSiembra}}">
                            @error('fechaSiembra')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" id="fechaCosechaEstimada" name="fechaCosechaEstimada"
                                class="form-control @error('fechaCosechaEstimada') is-invalid @enderror" value="{{$cosecha->fechaCosechaEstimada}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" id="fechaCosechaReal" name="fechaCosechaReal"
                                class="form-control @error('fechaCosechaReal') is-invalid @enderror" value="{{$cosecha->fechaCosechaReal}}">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="idInvernadero" name="idInvernadero"
                                ...
                                @foreach($invernaderos as $invernadero)
                                    <option value="{{ $invernadero->id }}"  @if ($cosecha->idCultivo=$invernadero->id)selected @endif>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="idCultivo" name="idCultivo"
                                ...
                                @foreach($cultivos as $cultivo)
                                    <option value="{{ $cultivo->id }}" @if ($cosecha->idCultivo=$cultivo->id)selected
                                        
                                    @endif>{{ $cultivo->nombre }}</option>
                                @endforeach
                            </select>
                            @error('idCultivo')
                                <div class="invalid-feedback">{{ $message }}</div>
