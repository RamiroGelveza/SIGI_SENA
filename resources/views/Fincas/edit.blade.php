@extends('layouts.app')
@section('title','Actualizar Fincas')

@section('titleContent')
<h1 class="text-center">Actualizar Finca</h1>
        ...
        <div class="col-lg-6">
            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-4">
                    <form action="{{ route('Fincas.update',$fincas->id) }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control  @error('nombre')
                                    is-invalid 
                                @enderror" id="nombre" name="nombre" value="{{$fincas->nombre}}" placeholder="Ej.: Finca La Esperanza"  >
                        ...
                        <div class="mb-3">
                            ...
                            <input 
                                type="text" id="ubicacion" name="ubicacion" value="{{$fincas->ubicacion}}" class="form-control form-control-lg @error('ubicacion')
                                is-invalid @enderror"
